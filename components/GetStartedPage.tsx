...
export const GetStartedPage: React.FC<GetStartedPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] py-16 px-6 md:px-12 flex flex-col items-center animate-in fade-in slide-in-from-bottom-4 duration-700 relative">
      <button 
      ...
      <div className="text-center space-y-8 mb-16 max-w-2xl">
        ...
        <div className="space-y-3">
          <h2 className="text-3xl md:text-4xl font-bold text-[#2E2A4A]">Let’s set things up 🌱</h2>
          <p className="text-lg text-[#6A6875]">One small step toward caring better.</p>
        </div>
      </div>
